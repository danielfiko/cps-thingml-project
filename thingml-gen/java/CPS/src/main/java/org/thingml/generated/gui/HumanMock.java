...
private final Set_energy_saving_tempMessageType set_energy_saving_tempType = new Set_energy_saving_tempMessageType();
...
private final SwitchStateOnMessageType SwitchStateOnType = new SwitchStateOnMessageType();
private final SwitchStateOffMessageType SwitchStateOffType = new SwitchStateOffMessageType();
private final StateQueryMessageType StateQueryType = new StateQueryMessageType();
private final CurrentPowerMessageType CurrentPowerType = new CurrentPowerMessageType();
private final TotalPowerMessageType TotalPowerType = new TotalPowerMessageType();
private final SwitchChangeOkMessageType SwitchChangeOkType = new SwitchChangeOkMessageType();
private final SwitchChangeFailMessageType SwitchChangeFailType = new SwitchChangeFailMessageType();
private final ResetTotalPowerMessageType ResetTotalPowerType = new ResetTotalPowerMessageType();
private final Current_powerMessageType current_powerType = new Current_powerMessageType();
private final Total_powerMessageType total_powerType = new Total_powerMessageType();
private final Show_current_powerMessageType show_current_powerType = new Show_current_powerMessageType();
private final Show_total_powerMessageType show_total_powerType = new Show_total_powerMessageType();
...
//Attributes related to ResetTotalPower via send_cmd
public JButton sendResetTotalPower_via_send_cmd;
private JTextField fieldResetTotalPower_via_send_cmd_Did;
public JTextField getFieldResetTotalPower_via_send_cmd_Did() {
return fieldResetTotalPower_via_send_cmd_Did;
}

public JButton getSendResetTotalPower_via_send_cmd() {
return sendResetTotalPower_via_send_cmd;
}

//Attributes related to set_energy_saving_temp via send_cmd
public JButton sendset_energy_saving_temp_via_send_cmd;
private JTextField fieldset_energy_saving_temp_via_send_cmd_T;
public JTextField getFieldset_energy_saving_temp_via_send_cmd_T() {
return fieldset_energy_saving_temp_via_send_cmd_T;
}

public JButton getSendset_energy_saving_temp_via_send_cmd() {
return sendset_energy_saving_temp_via_send_cmd;
}
...
sendResetTotalPower_via_send_cmd.setEnabled(false);
sendset_energy_saving_temp_via_send_cmd.setEnabled(false);
}
...
sendResetTotalPower_via_send_cmd.setEnabled(true);
sendset_energy_saving_temp_via_send_cmd.setEnabled(true);
}
...
fieldadd_thermometer_via_send_cmd_Id.setText("int");
c.gridx = 1;
c.gridy = 0
...
fieldadd_device_via_send_cmd_Did.setText("int");
c.gridx = 1;
c.gridy = 0
...
fieldset_polling_interval_via_send_cmd_Intrvl.setText("int");
c.gridx = 1;
c.gridy = 0
...
public JPanel createResetTotalPower_via_send_cmdPanel(){
GridBagConstraints c = new GridBagConstraints();
c.fill = GridBagConstraints.HORIZONTAL;
c.weightx = 0.5;
JPanel panel = new JPanel(new GridBagLayout());
...
c.gridy = 0;
panel.add(labeldid, c);
fieldResetTotalPower_via_send_cmd_Did = new JTextField();
fieldResetTotalPower_via_send_cmd_Did.setText("int");
c.gridx = 1;
c.gridy = 0
;panel.add(fieldResetTotalPower_via_send_cmd_Did, c);
return panel;
}

public JPanel createset_energy_saving_temp_via_send_cmdPanel(){
GridBagConstraints c = new GridBagConstraints();
c.fill = GridBagConstraints.HORIZONTAL;
c.weightx = 0.5;
JPanel panel = new JPanel(new GridBagLayout());
...
c.gridy = 0;
panel.add(labelt, c);
fieldset_energy_saving_temp_via_send_cmd_T = new JTextField();
fieldset_energy_saving_temp_via_send_cmd_T.setText("double");
c.gridx = 1;
c.gridy = 0
;panel.add(fieldset_energy_saving_temp_via_send_cmd_T, c);
return panel;
}
...
sendResetTotalPower_via_send_cmd.addActionListener(l);
sendset_energy_saving_temp_via_send_cmd.addActionListener(l);
}
...
tabbedPane.addTab("send_cmd", frame_send_cmd);
//GUI related to send_cmd_via_send_cmd => ResetTotalPower
c.gridy = 0;
c.gridx = 6;
frame_send_cmd.add(createLabel("ResetTotalPower"), c);
c.gridy = 1;
c.gridx = 6;
frame_send_cmd.add(createResetTotalPower_via_send_cmdPanel(), c);
c.gridy = 2;
c.gridx = 6;
c.weighty = 0;
sendResetTotalPower_via_send_cmd = createSendButton("send_cmd => ResetTotalPower");
frame_send_cmd.add(sendResetTotalPower_via_send_cmd, c);
tabbedPane.addTab("send_cmd", frame_send_cmd);
//GUI related to send_cmd_via_send_cmd => set_energy_saving_temp
c.gridy = 0;
c.gridx = 7;
frame_send_cmd.add(createLabel("set_energy_saving_temp"), c);
c.gridy = 1;
c.gridx = 7;
frame_send_cmd.add(createset_energy_saving_temp_via_send_cmdPanel(), c);
c.gridy = 2;
c.gridx = 7;
c.weighty = 0;
sendset_energy_saving_temp_via_send_cmd = createSendButton("send_cmd => set_energy_saving_temp");
frame_send_cmd.add(sendset_energy_saving_temp_via_send_cmd, c);
tabbedPane.addTab("send_cmd", frame_send_cmd);
...
Style receiveSwitchStateOn_via_get_valuesStyle = doc.addStyle("SwitchStateOn_via_get_values", null);
StyleConstants.setBackground(receiveSwitchStateOn_via_get_valuesStyle, new Color(251, 206, 203));
Style receiveSwitchStateOff_via_get_valuesStyle = doc.addStyle("SwitchStateOff_via_get_values", null);
StyleConstants.setBackground(receiveSwitchStateOff_via_get_valuesStyle, new Color(184, 206, 150));
...
try {
Map<String, Object> param = new HashMap<String, Object>();
param.put("intrvl", StringHelper.toObject (int.class, params[0].trim()));
...
else if (params[1].startsWith("ResetTotalPower")) {
params[1] = params[1].substring("ResetTotalPower".length(), params[1].length());
if (!(params[1].startsWith("(") && params[1].endsWith(")"))) {
cliButton.setForeground(alertColor);
cli.setText("port!message(param1, param2, param3)");
return;
...
Map<String, Object> param = new HashMap<String, Object>();
param.put("did", StringHelper.toObject (int.class, params[0].trim()));
Command c = new Command(port_Human_send_cmd, ResetTotalPowerType, param);c.execute();
((DefaultListModel)commands.getModel()).addElement(c);
cliButton.setForeground(Color.BLACK);
} catch(IllegalArgumentException iae) {
System.err.println("Cannot parse arguments for message ResetTotalPower on port send_cmd. Please try again with proper parameters");
cliButton.setForeground(alertColor);
}
}
else if (params[1].startsWith("set_energy_saving_temp")) {
params[1] = params[1].substring("set_energy_saving_temp".length(), params[1].length());
if (!(params[1].startsWith("(") && params[1].endsWith(")"))) {
cliButton.setForeground(alertColor);
cli.setText("port!message(param1, param2, param3)");
return;
...
Map<String, Object> param = new HashMap<String, Object>();
param.put("t", StringHelper.toObject (double.class, params[0].trim()));
Command c = new Command(port_Human_send_cmd, set_energy_saving_tempType, param);c.execute();
((DefaultListModel)commands.getModel()).addElement(c);
cliButton.setForeground(Color.BLACK);
} catch(IllegalArgumentException iae) {
System.err.println("Cannot parse arguments for message set_energy_saving_temp on port send_cmd. Please try again with proper parameters");
cliButton.setForeground(alertColor);
}
}
}
...
try{
Map<String, Object> param = new HashMap<String, Object>();
param.put("id", StringHelper.toObject (int.class, getFieldadd_thermometer_via_send_cmd_Id().getText()));
...
l.add_thermometer_from_send_cmd((Integer)StringHelper.toObject (int.class, getFieldadd_thermometer_via_send_cmd_Id().getText()), (String)StringHelper.toObject (String.class, getFieldadd_thermometer_via_send_cmd_Txt().getText()));
...
try{
Map<String, Object> param = new HashMap<String, Object>();
param.put("did", StringHelper.toObject (int.class, getFieldadd_device_via_send_cmd_Did().getText()));
Command c = new Command(port_Human_send_cmd, add_deviceType, param);c.execute();
((DefaultListModel)commands.getModel()).addElement(c);
for(IHuman_send_cmdClient l : send_cmd_listeners)
l.add_device_from_send_cmd((Integer)StringHelper.toObject (int.class, getFieldadd_device_via_send_cmd_Did().getText()));
...
try{
Map<String, Object> param = new HashMap<String, Object>();
param.put("intrvl", StringHelper.toObject (int.class, getFieldset_polling_interval_via_send_cmd_Intrvl().getText()));
Command c = new Command(port_Human_send_cmd, set_polling_intervalType, param);c.execute();
((DefaultListModel)commands.getModel()).addElement(c);
for(IHuman_send_cmdClient l : send_cmd_listeners)
l.set_polling_interval_from_send_cmd((Integer)StringHelper.toObject (int.class, getFieldset_polling_interval_via_send_cmd_Intrvl().getText()));
...
else if ( ae.getSource() == getSendResetTotalPower_via_send_cmd()) {
try{
Map<String, Object> param = new HashMap<String, Object>();
param.put("did", StringHelper.toObject (int.class, getFieldResetTotalPower_via_send_cmd_Did().getText()));
Command c = new Command(port_Human_send_cmd, ResetTotalPowerType, param);c.execute();
((DefaultListModel)commands.getModel()).addElement(c);
for(IHuman_send_cmdClient l : send_cmd_listeners)
l.ResetTotalPower_from_send_cmd((Integer)StringHelper.toObject (int.class, getFieldResetTotalPower_via_send_cmd_Did().getText()));
getSendResetTotalPower_via_send_cmd().setForeground(Color.BLACK);
} catch(IllegalArgumentException iae) {
System.err.println("Cannot parse arguments for message ResetTotalPower on port send_cmd. Please try again with proper parameters");
getSendResetTotalPower_via_send_cmd().setForeground(alertColor);
}
}
else if ( ae.getSource() == getSendset_energy_saving_temp_via_send_cmd()) {
try{
Map<String, Object> param = new HashMap<String, Object>();
param.put("t", StringHelper.toObject (double.class, getFieldset_energy_saving_temp_via_send_cmd_T().getText()));
Command c = new Command(port_Human_send_cmd, set_energy_saving_tempType, param);c.execute();
((DefaultListModel)commands.getModel()).addElement(c);
for(IHuman_send_cmdClient l : send_cmd_listeners)
l.set_energy_saving_temp_from_send_cmd((Double)StringHelper.toObject (double.class, getFieldset_energy_saving_temp_via_send_cmd_T().getText()));
getSendset_energy_saving_temp_via_send_cmd().setForeground(Color.BLACK);
} catch(IllegalArgumentException iae) {
System.err.println("Cannot parse arguments for message set_energy_saving_temp on port send_cmd. Please try again with proper parameters");
getSendset_energy_saving_temp_via_send_cmd().setForeground(alertColor);
}
}
